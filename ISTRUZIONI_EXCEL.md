...
| **Note** | ❌ | Note libere sull'articolo (conservazione, fornitore, ecc). Visibili solo nella scheda prodotto. | `Conservare a +4°C` |
...
6. **Data Scadenza**: Accettati i formati **GG-MM-AAAA** (es. `31-12-2026`) oppure **AAAA-MM-GG** (es. `2026-12-31`). Il sistema converte automaticamente. Se il prodotto è scaduto, apparirà in **rosso** nella lista del magazzino.
